            ...
            <div className='about-us-area privacy-policy__content pt-90 pb-100'>
				<div className='custom-container-8'>
					<div className='about-us-content-3'>
						<p>This privacy policy sets out how The Zenky uses and protects any information that you give The Zenky when you use this website.</p>
						<p>The Zenky is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, and then you can be assured that it will only be used in accordance with this privacy statement.</p>
						<p>The Zenky may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.</p>
						...
						<ul className="dotted-list">
							...
							<li>if you have previously agreed to us using your personal information for direct marketing purposes, you may change your mind at any time by writing to or emailing us at thezenkyofficial@gmail.com</li>
						</ul>
